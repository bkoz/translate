...
transformer = torch.load('translator.pt')
...
print(translate(transformer, "Eine Person isst Würstchen und trinkt Bier"))
print(translate(transformer, "Ein schneller Braunfuchs springt über den faulen Hund"))
print()
