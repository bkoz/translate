...
transformer.load_state_dict(torch.load('translator-dict.pt'))
transformer.to(DEVICE)
print(translate(transformer, "Eine Gruppe von Menschen steht vor einem Iglu ."))
print(translate(transformer, "Ein junger Mensch, der Gitarre spielt ."))
print(translate(transformer, "Ein junger Mensch fährt Fahrrad ."))
print(translate(transformer, "Eine Person isst Frankfurter und trinkt Bier ."))
print(translate(transformer, "Der schnelle Braunfuchs springt über den faulen Hund ."))
print()

while True:
    data = input("Please describe something in German:\n")
    if 'Exit' == data:
        break
    print(translate(transformer, data))
